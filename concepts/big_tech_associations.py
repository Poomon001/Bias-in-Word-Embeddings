...
def process(top_100k_file):
    ...
    largest.to_csv("../results/six_methods/big_tech/big_tech_associations_glove.csv")
    # largest.to_csv("../results/six_methods/big_tech/big_tech_associations_ft.csv")

if __name__ == "__main__":
    process("../raw/glove_100000_most_freq_skip.txt")