...
if __name__ == "__main__":
    ...
    plot("../results/six_methods/most_frequency_words/glove_100000_most_frequency.csv",
         "../plots/six_methods/most_frequency_words/glove_frequency_ratio.pdf", num_columns_list)

    plot("../results/openAI/most_frequency_words/openAI_100000_most_frequency.csv",
         "../plots/openAI/most_frequency_words/openai_frequency_ratio.pdf", num_columns_list)
    ...
    plot("../results/microsoft/most_frequency_words/microsoft_100000_most_frequency.csv",
             "../plots/microsoft/most_frequency_words/microsoft_frequency_ratio.pdf", num_columns_list)

    plot("../results/microsoft_norm/most_frequency_words/microsoft_norm_100000_most_frequency.csv",
             "../plots/microsoft_norm/most_frequency_words/microsoft_norm_frequency_ratio.pdf", num_columns_list)

    plot("../results/BGE/most_frequency_words/BGE_100000_most_frequency.csv",
             "../plots/BGE/most_frequency_words/BGE_frequency_ratio.pdf", num_columns_list)
